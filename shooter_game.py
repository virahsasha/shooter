    ...
    while menu:
        ...
        for e in event.get():
            if e.type == QUIT:
                ...
                if e.key == K_e:
                    menu = False
        mw.blit(text_name, ((w/2)-100, 100))
        mw.blit(text_play, ((w/2)-100, 150))
        mw.blit(text_exit, ((w/2)-100, 210))
        ...
        if not finish:
            ...
            if rel_time:
                ...
                if now_time - last_time < 3:
                    reload = text1.render("Wait, reloading...", 1,  (127, 211, 123),(223,65,18))
            ...
            text_lost = text1.render("Пропущено:" +str(score), 1,(135,145,240))
